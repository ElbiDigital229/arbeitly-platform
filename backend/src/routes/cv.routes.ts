...
import { uploadRateLimiter, exportRateLimiter } from '../middleware/rateLimiter.middleware.js';
...
router.post('/export', exportRateLimiter, cvController.exportCVFromHtml);
router.post('/', uploadRateLimiter, upload.single('file'), cvController.uploadCV);
router.get('/', cvController.getCVs);
router.get('/:id', cvController.getCVById);
router.put('/:id', validate(UpdateCVDto), cvController.updateCV);
router.delete('/:id', cvController.deleteCV);
router.get('/:id/export', exportRateLimiter, cvController.exportCVToPDF);
