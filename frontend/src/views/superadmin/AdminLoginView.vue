    ...
    <div class="flex-1 flex items-center justify-center p-6 bg-background">
      <div class="w-full max-w-sm">
        ...
        <div class="mt-6 border-t border-border pt-4">
          ...
          <button @click="email = 'admin@arbeitly.de'; password = 'admin2024'; handleLogin()" class="w-full h-9 rounded-lg text-xs font-medium border border-border text-foreground hover:bg-secondary/60 transition-colors flex items-center justify-center gap-2">
            <span class="mdi mdi-flash text-yellow-400" /> Sign in as Admin
          </button>
        </div>
