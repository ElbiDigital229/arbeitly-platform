  ...
  <div class="flex h-screen overflow-hidden bg-background">
    ...
    >
      ...
      <nav class="flex-1 py-3 px-2 overflow-y-auto space-y-0.5">
        <p v-if="!collapsed" class="px-3 pb-1 text-[10px] font-semibold uppercase tracking-wider text-sidebar-foreground/50">My Portal</p>
        ...
        <!-- Account section -->
        <div class="pt-3">
          <p v-if="!collapsed" class="px-3 pb-1 text-[10px] font-semibold uppercase tracking-wider text-sidebar-foreground/50">Account</p>
